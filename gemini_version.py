...
# Fix: ensure event loop exists in Streamlit thread
...
GEMINI_API_KEY = os.getenv("GOOGLE_API_KEY") or ("AIzaSyAfp1jRyQ1q9XG9xocElkGvt128-4bBWqE")
...
st.set_page_config(
    page_title="QuestRAG-Question-Answering-with-RAG",
    page_icon="📄",
    layout="wide"
)
...
def main():
    ...
    st.title("📚 QuestRAG-Question-Answering-with-RAG")
